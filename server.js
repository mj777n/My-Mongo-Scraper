...
var MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost/mongo-scraperdb";
  ...
  // Or connect via Heroku using mLabs add-on. But this is not connecting.
  // **** Geting a bunch of "H10" error messages from Heroku Logs. Ughhhhh!!! ****

  // This is the connection driver recommended by mLabs. It contains correct username and password and syntax.
  ...
  //   console.log("\n"+"*********************************************");
    console.log("\n"+"The server is happily listening on port " + PORT);
